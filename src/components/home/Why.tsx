...
const Why = () => {
  return (
    <div className="w-full fontstyle2 ">
      <div className="mx-auto overflow-x-hidden mt-10 w-full max-w-screen-xl px-4">
        <div className="w-12 border-b-2 border-pink-500 lg:border-b-4"></div>
        <h2 className="mt-6 mb-10 text-3xl font-semibold tracking-wide text-gray-800 sm:text-6xl">
          Why Learnster?
        </h2>
                ...
                >
                  ...
                  >
                    <stop
                      ...
                      contentStyleType="stop-color: #d500f9"
                    ></stop>
                    <stop
                      offset="1"
                      className="secondary-color-gradient"
                      contentStyleType="stop-color: #ffea00"
                    ></stop>
                  </linearGradient>
                  <path
                    fill="url(#SVGID_1_)"
          ...
          <div className="mt-8 lg:mt-10 lg:w-1/2">
            <div className="flex flex-col items-start lg:pr-16">
              ...
              <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">
                ...
                tenetur sequi exercitationem eveniet.
              </p>
            </div>
          </div>
          <div className="mt-8 lg:mt-10 lg:w-1/2">
                ...
                >
                  ...
                  >
                    <stop
                      offset="0"
                      className="primary-color-gradient"
                      contentScriptType="stop-color: #d500f9"
                    ></stop>
                    <stop
                      offset="1"
                      className="secondary-color-gradient"
                      contentScriptType="stop-color: #ffea00"
                    ></stop>
                  </linearGradient>
                  <path
                    fill="url(#SVGID_1_)"
