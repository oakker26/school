    ...
    <div>
      <div className="flex flex-col md:flex-row px-8 py-14 gap-10 ">
        ...
        <div className="md:w-1/2 flex flex-col items-center gap-4 pt-4">
          <h3 className="text-2xl font-bold fontstyle2 ">Preschool</h3>
          <p className="fontstyle2 lg:px-14">
            ...
            respected, loved and cared for. Our Nurturing Early Learners
            Framework aims to build the foundation for children to achieve the
            desired outcomes of education and key stage outcomes by helping them
            acquire knowledge. Download Brochure
          </p>
      ...
      {click && (
        <div className="border lg:mx-14 mx-6 flex flex-col gap-4 py-10 lg:px-10 px-4 fontstyle2 relative ">
            <button onClick={()=>setClick(false)}><FaAngleDown/></button>
