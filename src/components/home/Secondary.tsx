    ...
    <div>
      <div className="flex flex-col md:flex-row px-8 py-14 gap-10 ">
        ...
        <div className="md:w-1/2 flex flex-col items-center gap-4 pt-4">
          <h3 className="text-2xl font-bold fontstyle2 ">Secondary</h3>
          <p className="fontstyle2 lg:px-14">
            The SIS Secondary School Curriculum adopts both the Singaporean and
            the Cambridge University programme. This programme is for students
            from the age group of 13 – 16 years old. The students are made
            familiar with a broad range of experiences.
          </p>
